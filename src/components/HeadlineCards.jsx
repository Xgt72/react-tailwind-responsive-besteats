    ...
    return (
        <section className="max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
            <figure className="rounded-xl relative">
                <figcaption className="absolute w-full h-full bg-black/50 rounded-xl text-white">
                ...
                <img
                    ...
                    src="https://images.pexels.com/photos/6529815/pexels-photo-6529815.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                    alt=""
                />
            </figure>
            <figure className="rounded-xl relative">
